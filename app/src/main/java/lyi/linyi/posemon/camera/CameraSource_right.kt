...
import lyi.linyi.posemon.rightarm.VisualizationUtils
import lyi.linyi.posemon.rightarm.YuvToRgbConverter
...
class CameraSource_right(
    ...
    private var classifier: PoseClassifier_rightarm? = null
    ...
    fun setClassifier(classifier: PoseClassifier_rightarm?) {
        synchronized(lock) {
